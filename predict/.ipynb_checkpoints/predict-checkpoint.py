...
# os.environ["ELASTIC_HOST"] = '10.42.6.227'
# os.environ["ELASTIC_INDEX"] = 'test'
# os.environ["MODEL_NAME"] = 'gpt-3.5-turbo'
# # gpt-3.5-turbo	
# os.environ["RETRIEVER_N"] = '5'
# os.environ["RANKER_N"] = '2'
# os.environ["LLM_API_KEY"] = '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'
# os.environ["URL"] = 'https://inference-1044-1.amr2uxdpwunywjqvp2kefkp.cloud.cnvrg.io/api/v1/endpoints/dmskvmsq9n3xlrxzsvwu'
...
# ### Instruction:
# You are a doctor. Synthesize a comprehensive answer strictly from the following Input and the question: {query}
